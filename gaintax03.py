...
p21=np.zeros(nzb)
p22=np.zeros(nzb)
b1=np.floor(np.round((new_b-blow)/db,5))*db+blow
b2=np.ceil(np.round((new_b-blow)/db,5))*db+blow
z1=np.floor(np.round((new_z-zlow)/dz,5))*dz+zlow
z2=np.ceil(np.round((new_z-zlow)/dz,5))*dz+zlow
delta_b1=new_b-b1
...
p11=np.round((c_b1-blow)/db)*nz+np.round((c_z1-zlow)/dz)
p12=np.round((c_b1-blow)/db)*nz+np.round((c_z2-zlow)/dz)
p21=np.round((c_b2-blow)/db)*nz+np.round((c_z1-zlow)/dz)
p22=np.round((c_b2-blow)/db)*nz+np.round((c_z2-zlow)/dz)
p=np.arange(nzb)
